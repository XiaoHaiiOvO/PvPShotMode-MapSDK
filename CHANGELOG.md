...
- Use the current global `SimpleFPSController` type and its `playerCamera` field when creating and removing the editor test player.
- Preserve the expanded first/third-person controller introduced after 2.4.0.
