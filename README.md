...
《How to Fish》PvPShotMode 的 Unity 地图制作工具，版本 **2.4.2**。
...
```text
https://github.com/XiaoHaiiOvO/PvPShotMode-MapSDK.git#v2.4.2
```

也可以在工程的 `Packages/manifest.json` 中添加：

```json
"com.htf.pvpshotmode-mapsdk": "https://github.com/XiaoHaiiOvO/PvPShotMode-MapSDK.git#v2.4.2"
```
